...
export default function PrivacyPolicyPage()
{
    ...
    <div>
        <article className="legal-content">
            ...
            <h2>4. Armazenamento e segurança</h2><p>Os registros operacionais são armazenados em ambiente controlado pela {metadata.companyName}, com acesso restrito ao necessário para operação, suporte e segurança. Adotamos medidas técnicas e organizacionais razoáveis para proteger os dados contra acesso não autorizado, perda ou uso indevido.</p>
            ...
            <h2>6. Seus direitos e contato</h2><p>Você pode solicitar esclarecimentos, acesso, correção ou eliminação de dados aplicáveis, bem como pedir o encerramento de contatos. Para isso, fale com {metadata.ownerName} pelo <a href={metadata.whatsappLink}>WhatsApp</a>.</p>
            ...
            <p className="legal-footer"><strong>{metadata.companyName}</strong><br /><a href={metadata.companyWebsite}>{metadata.companyWebsite}</a></p>
        </article>
    </div> 
    );
}
